...
class DrownedPirates (event.Event):
    ...
    def process (self, world):
        ...
        #ship.Ship().medicine = ship.Ship().medicine + 3
        """
        result["message"] = "You obtained medicine from the corpse of Drowned pirates"
        ship_medicine = config.the_player.ship
        ship_medicine.food =  ship_medicine.medicine + 3
        """
